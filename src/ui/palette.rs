...
impl CommandKind {
    ...
    pub fn id(&self) -> Option<&'static str> {
        ...
        Some(match self {
            ...
            ToggleBroadcastInput => "broadcast-input",
            ToggleBroadcastPane => "broadcast-pane",
    ...
    fn key_spec(&self, cx: &App) -> Option<String> {
        ...
        let action = match self {
            ...
            ToggleBroadcastInput => "ToggleBroadcastInput",
            ToggleBroadcastPane => "ToggleBroadcastPane",
...
impl Command {
    ...
    pub fn base_commands(cx: &App, chrome: ChromeState) -> Vec<Command> {
        ...
        let tabs = [
            ...
            Command::localized(L10nKey::CmdToggleBroadcastInput, ToggleBroadcastInput),
            Command::localized(L10nKey::CmdToggleBroadcastPane, ToggleBroadcastPane),
