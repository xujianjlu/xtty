...
mod tests {
    ...
    fn a_tab_of_another_window_is_named_the_way_a_local_one_would_be() {
        ...
        assert_eq!(tab_view_label(&view, 0, None, crate::ui::tab_strip::TabChipOptions::default()), "build", "a given name wins");

        view.name = None;
        assert_eq!(
            tab_view_label(&view, 0, None, crate::ui::tab_strip::TabChipOptions::default()),
        ...
        assert!(tab_view_label(&view, 2, None, crate::ui::tab_strip::TabChipOptions::default()).contains('3'));
    }
}
