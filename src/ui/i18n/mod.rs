...
l10n_keys! {
    ...
    SettingsCursorBlinkInterval,
    SettingsCursorBlinkIntervalDesc,
    SettingsTabStyle,
    SettingsTabShowUserHost,
    SettingsTabShowUserHostDesc,
    SettingsTabShowCwdBasename,
    SettingsTabShowCwdBasenameDesc,
    SettingsTabShowGitBranch,
    SettingsTabShowGitBranchDesc,
    SettingsTabShowAgentIcon,
    SettingsTabShowAgentIconDesc,
    SettingsSearchTabShowUserHostKeywords,
    SettingsSearchTabShowCwdBasenameKeywords,
    SettingsSearchTabShowGitBranchKeywords,
    SettingsSearchTabShowAgentIconKeywords,
    SettingsLanguage,
    ...
    SettingsProxyJump,
    SettingsProxyJumpDesc,
    SettingsJumpUser,
    SettingsJumpUserDesc,
    SettingsJumpPort,
    SettingsJumpPortDesc,
    SettingsJumpKeepalive,
    SettingsJumpKeepaliveDesc,
    SettingsJumpSshOptions,
    SettingsJumpSshOptionsDesc,
    SettingsJumpSshOptionsHint,
    SettingsInteractiveJump,
    SettingsHopReadyPrompt,
    SettingsHopReadyPromptDesc,
    SettingsHopReadyPromptHint,
    ...
    SettingsSearchCursorBlinkIntervalKeywords,
    ...
    SettingsSearchPasswordTriggersKeywords,
    SettingsSearchPasswordTriggerSendEnterKeywords,
    SettingsPasswordTriggersIntro,
    SettingsPasswordTriggersIntroDesc,
    SettingsPasswordTriggerPattern,
    SettingsPasswordTriggerPatternDesc,
    SettingsPasswordTriggerPatternHint,
    SettingsPasswordTriggerPatternRequired,
    SettingsPasswordTriggerRegex,
    SettingsPasswordTriggerRegexDesc,
    SettingsPasswordTriggerLiteral,
    SettingsPasswordTriggerCredential,
    SettingsPasswordTriggerCredentialDesc,
    SettingsPasswordTriggerCredentialHint,
    SettingsPasswordTriggerCredentialRequired,
    SettingsPasswordTriggerSendEnter,
    SettingsPasswordTriggerSendEnterDesc,
    SettingsPasswordTriggerSendEnterShort,
    SettingsPasswordTriggerEnabled,
    SettingsPasswordTriggerCooldown,
    SettingsPasswordTriggerCooldownDesc,
    SettingsPasswordTriggerEmpty,
    SettingsPasswordTriggerBadRegex,
    SettingsPasswordTriggerBadCooldown,
    SettingsPasswordTriggerSecretRequired,
    SettingsPasswordTriggerSecretKept,
    SettingsPasswordTriggerSecretNeeded,
    SettingsPasswordTriggerSecretHintKeep,
    SettingsPasswordTriggerSecretHintNew,
    SettingsPasswordTriggerDeleteTitle,
    SettingsPasswordTriggerDeleteBody,
    SettingsCouldntSaveTriggerSecret,
    SettingsNewPasswordTrigger,
    SettingsEditPasswordTrigger,
    ...
    AppMenuZoomPane,
    AppMenuToggleBroadcastInput,
    AppMenuBroadcastPaneExclude,
    AppMenuBroadcastPaneInclude,
    ...
    CmdSplitDown,
    CmdZoomPane,
    CmdToggleBroadcastInput,
    CmdToggleBroadcastPane,
    CmdNextPane,
    CmdPreviousPane,
    CmdFocusPaneLeft,
    CmdFocusPaneRight,
...
mod tests {
    ...
    fn every_key_is_translated_in_every_locale() {
        ...
        const KEPT_IN_ENGLISH: &[L10nKey] = &[
            ...
            // Example values shown as placeholders — they are sample prompt
            // text and a keychain account name, not UI chrome to translate.
            L10nKey::SettingsPasswordTriggerPatternHint,
            L10nKey::SettingsPasswordTriggerCredentialHint,
        ];
