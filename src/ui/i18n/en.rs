...
pub fn translate_en(key: L10nKey) -> &'static str {
    match key {
        ...
        L10nKey::CmdToggleBroadcastInput => "Broadcast Input (Current Tab)",
        L10nKey::CmdToggleBroadcastPane => "Include / Exclude Pane from Broadcast",
        ...
        L10nKey::AppMenuToggleBroadcastInput => "Broadcast Input to Tab Panes",
        L10nKey::AppMenuBroadcastPaneExclude => "Exclude Pane from Broadcast",
        L10nKey::AppMenuBroadcastPaneInclude => "Include Pane in Broadcast",
