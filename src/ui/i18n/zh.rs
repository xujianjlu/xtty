...
pub fn translate_zh(key: L10nKey) -> Option<&'static str> {
    Some(match key {
        ...
        L10nKey::SettingsCursorBlinkInterval => "闪烁间隔",
        ...
        L10nKey::SettingsSearchTabShowAgentIconKeywords => {
            "标签 标题 agent 头像 claude codex 图标 tab"
        }
        ...
        L10nKey::SettingsSearchCursorBlinkIntervalKeywords => {
            "闪烁间隔 闪烁频率 闪烁速度 秒 光标 快 慢 blink interval rate speed frequency seconds sec s"
        }
        ...
        L10nKey::CmdToggleBroadcastInput => "广播输入（当前标签）",
        L10nKey::CmdToggleBroadcastPane => "加入/排除广播窗格",
        ...
        L10nKey::AppMenuToggleBroadcastInput => "广播输入到标签内窗格",
        L10nKey::AppMenuBroadcastPaneExclude => "从广播中排除此窗格",
        L10nKey::AppMenuBroadcastPaneInclude => "将此窗格加入广播",
