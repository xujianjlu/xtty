...
pub fn translate_ja(key: L10nKey) -> Option<&'static str> {
    Some(match key {
        ...
        L10nKey::CmdToggleBroadcastInput => "入力を同タブのペインへブロードキャスト",
        L10nKey::CmdToggleBroadcastPane => "ブロードキャストに含める/除外",
        ...
        L10nKey::AppMenuToggleBroadcastInput => "入力をタブ内ペインへブロードキャスト",
        L10nKey::AppMenuBroadcastPaneExclude => "このペインをブロードキャストから除外",
        L10nKey::AppMenuBroadcastPaneInclude => "このペインをブロードキャストに含める",
