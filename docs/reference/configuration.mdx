...
| Key | Type | Default | |
|---|---|---|---|
| `history_search` | bool | `true` | tty7's fuzzy history on <kbd>⌃ R</kbd> or <kbd>⌘ R</kbd>. Works after an inner SSH/jumper/su where shell integration is unavailable. Off hands the key to the shell. |
