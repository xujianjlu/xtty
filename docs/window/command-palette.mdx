...
| **View** | Show/Hide Left Sidebar · Show Code Panel · Tab Bar: Move to Top · Change Theme… · Enter Full Screen · Toggle Unified / Side-by-Side Diff |
...
| **SSH** | Add Connection… · Manage Profiles… · Reconnect |
...
from the workspace switcher. [Remote workspaces →](/remote/workspaces)
